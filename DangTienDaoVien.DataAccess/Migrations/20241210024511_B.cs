        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Level = table.Column<string>(type: "nvarchar(max)", nullable: false, defaultValue: "None"),
                    Role = table.Column<string>(type: "nvarchar(max)", nullable: false, defaultValue: "None"),
                    TotallReadTime = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Truyen_TacGia_TacGiaId",
                        column: x => x.TacGiaId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NoiDung = table.Column<string>(type: "nvarchar(max)", maxLength: 10000, nullable: false),
                    TruyenId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ChuongTruyen", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ChuongTruyen_Truyen_TruyenId",
                        column: x => x.TruyenId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TheLoaiTruyen", x => new { x.TheLoaiId, x.TruyenId });
                    table.ForeignKey(
                        name: "FK_TheLoaiTruyen_TheLoai_TheLoaiId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserTruyen", x => new { x.UserId, x.TruyenId });
                    table.ForeignKey(
                        name: "FK_UserTruyen_Truyen_TruyenId",
                        column: x => x.TruyenId,
                        principalTable: "Truyen",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_UserTruyen_User_UserId",
                        column: x => x.UserId,
                        principalTable: "User",
                        principalColumn: "Id");
                });
